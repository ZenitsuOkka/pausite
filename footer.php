<div class="question">
            ...
            <div class="reply__body">
                ...
                <form action="#">
                    <div class="reply__wrapper">
                        <div>
                            <label for="name">Ваше імʼя <span>*</span></label>
        ...
        <footer>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <a href="#" class="footer__policy">Політика конфіденціальності</a>
                    </div>
                </div>
            </div>
        </footer>
        <?php 
            wp_footer();
        ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyARq9LHWi4BJmSDRlUQLtMo1Dy4x6PUgfw"></script>
