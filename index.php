...
?>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php echo bloginfo('template_url'); ?>/assets/img/team.png" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                <h1 class="title">Наші послуги</h1>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            Ми надаємо наступні послуги в даній практиці:
                        </div>
                        <div class="aboutus__text">
                           <ul>
                                <li>Розробка, внесення змін, та узгодження договорів (в тому числі ЗЕД договорів)</li>
                                <li>Супровід переговорів з контрагентами</li>
                                <li>Надання відповідей на запити контролюючих органів</li>
                                <li>Реєстрація бізнесу в Україні та за кордоном</li>
                                <li>Розробка внутрішньої документації</li>
                                <li>Розробка установчих документів, внесення змін в установчі документи</li>
                                <li>Аналіз контрагентів</li>
                                <li>Супровід перевірок контролюючих органів</li>
                                <li>Супровід взаємовідносин з банком, в тому числі надання допомоги при проходженні фінансового моніторингу</li>
                                <li>Відкриття банківських рахунків</li>
                           </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="subtitle">
                            Ми маємо експертизу в таких справах
                        </div>
                        <div class="aboutus__text">
                            <ul>
                                <li>Спори в сфері нерухомості і будівництва</li>
                                <li>Кредитні та іпотечні спори</li>
                                <li>Податкові спори</li>
                                <li>Спори з суб’єктами владних повноважень</li>
                                <li>Стягнення заборгованості</li>
                                <li>Міжнародний арбітраж</li>
                                <li>Спори в сфері публічних закупівель</li>
                                <li>Інвестиційні спори</li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="aboutus__text">
                            <ul>
                                <li>Супровід угод з купівлі-продажу компаній</li>
                                <li>КПредставництво інтересів покупців і продавців у процесі укладання угод із злиття та поглинання</li>
                                <li>Реалізація угод пов’язаних із зміною корпоративного контролю</li>
                                <li>Інвестиційні проекти</li>
                                <li>Підготовка та супровід виходу на український ринок</li>
                                <li>Реєстрація іноземних компаній</li>
                                <li>Створення спільного підприємства</li>
                                <li>Юридичний аудит бізнесу</li>
                                <li>Супровід припинення юридичних осіб</li>
        ...
        <div class="contacts" id="contacts">
            <h1 class="title">Де нас шукать</h1>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            Ми знаходимось в Києві, вул. Михайла Бойчука 30
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="title contacts__minititle">Звʼяжіться з нами</div>
                        <div class="contacts__info">
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+380997349056">+380997349056</a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                            ...
                            <div class="contacts__mail">
                                ...
                                <a href="mailto:mirdetstva@gmail.com">info@pau.in.ua</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="title contacts__minititle">Замовити консультацію</div>
                        <div class="contacts__feed">
                            <?php echo do_shortcode('[contact-form-7 id="89" title="Форма заяки"]'); ?>
                        </div>
                    </div>
                </div>
            </div>
