        ...
        <header>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-11 col-sm-12 col-md-12 col-lg-1">
                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <a href="mailto:mirdetstva@gmail.com" class="header__contacts-mail">info@pau.in.ua</a>
                            </div>
                            <div class="header__contacts-item">
                ...
                <nav class="row" data-slide="1">
                    <ul class="header__nav">
                        ...
                        <li>
                            <a class="header__nav-item" href="#toys">Послуги</a>
                        </li>
                        <li>
                            <a class="header__nav-item" href="#aboutus">Наша історія</a>
                        </li>
                        <li>
                            <a class="header__nav-item" href="#contacts">Контакти</a>
                        </li>
                    </ul>
                </nav>
            </div>
